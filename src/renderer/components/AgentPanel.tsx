...
export const AgentPanel: React.FC<AgentPanelProps> = ({
  ...
  return (
    <>
      <AppPageLayout
        title="Agents"
        subtitle="Orchestrate coding agents and review their changes"
        actions={
          <button
      ...
      >
        <div className="page-layout-grid">
          <aside className="col-span-12 lg:col-span-4 bg-[var(--bg-card)] border border-[var(--border-subtle)] rounded-[var(--radius-lg)] overflow-hidden min-h-[640px] flex flex-col">
            <div className="p-4 border-b border-[var(--border-subtle)]">
              <h3 className="text-[13px] font-medium text-[var(--text-primary)]">Active Agents</h3>
              <p className="text-[11px] text-[var(--text-muted)] mt-1">{agents.length} total</p>
            </div>
          ...
          <section className="col-span-12 lg:col-span-8 bg-[var(--bg-card)] border border-[var(--border-subtle)] rounded-[var(--radius-lg)] overflow-hidden min-h-[640px] flex flex-col">
            {selectedAgent ? (
              <>
                      ...
                      <div className="bg-[var(--bg-card)] border border-[var(--border-subtle)] rounded-[var(--radius-lg)] p-4">
                        ...
                        <div className="mt-3 flex gap-2">
                          ...
                          <input
                            ...
                            className="flex-1 px-3 py-2 bg-[var(--bg-elevated)] border border-[var(--border-subtle)] rounded-[var(--radius-md)] text-[12px] text-[var(--text-primary)] placeholder:text-[var(--text-disabled)] focus:outline-none focus:border-[var(--a-500)]"
                          />
                          <button
                            onClick={() => {
                            ...
                            >
                              ...
                              {task.status === 'running' && (
                                <div className="mt-2 h-1 bg-[var(--bg-hover)] rounded-full overflow-hidden">
                                  <div
                                    className="h-full bg-[var(--a-500)] transition-all"
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 bg-[var(--bg-elevated)] border border-[var(--border-subtle)] rounded-[var(--radius-md)] text-[13px] text-[var(--text-primary)] placeholder:text-[var(--text-disabled)] focus:outline-none focus:border-[var(--a-500)]"
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-[var(--radius-sm)] text-[12px] transition-colors ${
                        newAgentConfig.skills.includes(skill.id)
                          ? 'bg-[var(--bg-hover)] border border-[var(--border-default)] text-[var(--text-primary)]'
                          : 'bg-[var(--bg-hover)] border border-transparent text-[var(--text-secondary)] hover:bg-[var(--bg-active)]'
                      }`}
                    >
                      {skill.name}
                    </button>
